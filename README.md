...
* **[기술/성능] Uniform Grid 공간 분할**: 2,000개 부품 렌더링 시 발생하는 딜레이(780ms)를 해결하기 위해 게임 개발에서 쓰이는 공간 분할 기법(Uniform Grid)을 도입했습니다. Point query와 range query의 탐색 복잡도를 $O(N)$에서 Amortized $O(1)$로 낮춰 렌더링 성능을 **12ms**로 98% 단축했습니다.
...
* 아이들이 지루함을 느끼지 않을 수준의 빠른 생성 속도를 확보하고, 사용자의 의도가 정확히 반영된 고품질 동화책 생성 시스템을 완성했습니다.
